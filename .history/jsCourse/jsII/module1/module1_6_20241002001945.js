...
//Adding a new prop
point3.z = 40;
console.log(point3.z);    // 40this result it's because we have stored on point3 the point1 reference
console.log(point1.z);    // 40 this result it's because we have stored on point3 the point1 reference

...
//Arrays as a complex type
//Arrays are data collections - an ordered set of different values can be placed in one variable
let a = [10, 20, "en to tre", true, 50]; //Array
//Indexes start at 0
a[4] = a[4] * 2;
console.log(a[0]);    // -> 10
...
//An object as different type of array
...
console.log(sampleObject.name); // -> en to true

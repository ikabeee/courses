...
let ColoredPoint = function(x, y, color) { //constructor. n the constructor, this is not necessary, after running it with new, it will automatically return an implicitly created object
    let _info = "... object under construction";
    let _color = color;
    console.log(_info);
